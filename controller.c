...
void ME7() {
	...
	switch (currentState7) {
		...
		case INICIO_V4 :
			...
			else if(SV2 == 4 && currentState9==OCUPADO) {
...
int main() {
	...
	while(1) {
		...
		T2A = (currentState1 != PARADO) || (currentState5 == INICIA_TRANSF1) || (currentState5 == AVANÇA_T2) || (currentState6 == INICIA_TRANSF_V1) || (currentState8 == AVANÇA_A_T2);
